            ...
            <section className="space-y-8">
              <div className="space-y-3">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  The calculator uses the standard Cartesian coordinate system (x, y, z) for tensor components. The
                  orientation of these axes relative to the crystallographic axes (a, b, c) depends on the crystal
                  system:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 border border-ink border-opacity-10 space-y-2">
                    ...
                    <p className="text-xs opacity-70 leading-relaxed">
                      The Cartesian axes are orthogonal, while the crystallographic axes (<InlineMath math="a_1, a_2" />
                ...
                <p className="text-sm opacity-70 leading-relaxed mt-4">
                  The triclinic and monoclinic conventions follow the standard crystal-physics prescription (Haussuehl
                  1983, based on IRE 1949): <InlineMath math="z \parallel c" />,{' '}
                  <InlineMath math="y \parallel (c \times a)" />, <InlineMath math="x = y \times z" />. The set of
                  independent and zero tensor components does <strong>not</strong> depend on this choice, but the
                  numeric component values — and therefore the orientation of simulated polarimetry patterns —{' '}
                  <strong>do</strong>.
                </p>
                <p className="text-sm opacity-70 leading-relaxed mt-2">
                  <strong>Why there is no monoclinic-angle control:</strong> The angle <InlineMath math="\beta" /> does
                  not enter the symmetry calculation directly. A crystal with a different <InlineMath math="\beta" /> is
                  a different material with different tensor values, so it is represented by adjusting the relevant
                  in-plane component values — not by a separate geometric control. Linear-optical effects such as
                  birefringence, which do depend on <InlineMath math="\beta" />, are outside the scope of this symmetry
                  calculator.
                </p>
                <p className="text-xs opacity-70 leading-relaxed italic">
                  For lattice conditions and defining symmetry per system, see the Explorer's per-crystal-system info
                  panel.
                </p>
              </div>
              ...
              <div className="space-y-3 pt-4 border-t border-ink border-opacity-10">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  Some magnetic point groups admit more than one valid orientation of their symmetry elements relative
                  to the Cartesian axes; each valid choice is a <strong>setting</strong>. A different setting never
                  changes which tensor components are independent or zero — only which axis labels they carry. Matching
                  the setting of your reference data matters when comparing component values; it never changes whether
                  an effect is allowed. Example: <InlineMath math="6'mm'" /> and <InlineMath math="6'm'm" /> are two
                  settings of the same group, 30° apart.
                </p>
                <p className="text-sm opacity-70 leading-relaxed">
                  The app implements all settings via the similarity transform{' '}
                  <InlineMath math="G' = S \cdot G \cdot S^{-1}" /> applied to the base generators. A setting selector
                  appears in the group info header, shared by the Calculator and the Simulator, whenever a group has
                  multiple settings, and the choice persists between the two views. No group has more than 3 settings.
                </p>
                <p className="text-sm opacity-70 leading-relaxed">
                  ...
                  ); where the short symbol is identical for every setting (orthorhombic, monoclinic), buttons instead
                  read an axis word — c-unique, a-unique, or b-unique — plus that shared symbol.
                </p>
                <p className="text-xs opacity-70 leading-relaxed italic">
              ...
              <div className="space-y-4 pt-4 border-t border-ink border-opacity-10">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  ...
                  <em>which</em> physical frame is selected; convention only picks <em>which naming rule</em> labels
                  that frame. Switching convention never changes the selected frame or any computed tensor value — only
                  which symbol is displayed.
                </p>
                <p className="text-sm opacity-70 leading-relaxed">
                  The convention is a single global toggle (<strong>BIRSS | ITC</strong>) in the app header. It relabels
                  group names app-wide — Explorer, search, Calculator, and Simulator — and opens newly selected groups
                  on the active convention's standard frame. Toggling it while a group is already open keeps the current
                  physical frame; it only relabels it.
                </p>
                <p className="text-sm opacity-70 leading-relaxed">
                  The two rules disagree on one point: for trigonal/hexagonal groups, Birss reads HM position 2 from the{' '}
                  <InlineMath math="y" />
                  -axis family, while ITC reads it from the <InlineMath math="x" /> (a-axis) family — the two families
                  are 30° apart. This has three distinct effects:
                </p>
                <ul className="text-sm opacity-70 list-disc list-inside space-y-2 ml-4">
                  <li>
                    ...
                    <InlineMath math="6'mm'" />, the app's default frame is Birss's <InlineMath math="6'mm'" /> and
                    ITC's <InlineMath math="6'm'm" />; the alternate setting is Birss's <InlineMath math="6'm'm" /> and
                    ITC's <InlineMath math="6'mm'" />. The physics is identical (labels swap; ITC mode opens the group
                    on the setting ITC would call by the group's key); this covers the trigonal{' '}
                    <InlineMath math="32/3m/\bar{3}m" /> family and the seven affected hexagonal groups.
                  </li>
                  <li>
                    <strong>Tetragonal Mechanism-A pairs are convention-neutral:</strong> for groups like{' '}
                    <InlineMath math="\bar{4}2m" />, the 4-fold makes the <InlineMath math="x" /> and{' '}
                    <InlineMath math="y" /> secondary families equivalent, so Birss's and ITC's position-2 readings
                    always agree — no label change in either mode.
                  </li>
                  <li>
                    <InlineMath math="m'm'm" />: <strong>orthorhombic frame symbols are convention-independent</strong>{' '}
                    (the c-unique frame is always <InlineMath math="m'm'm" />, the a-unique frame always{' '}
                    <InlineMath math="mm'm'" />
                    ). The conventions differ only in which frame is the standard — Birss: c-unique (
                    <InlineMath math="m'm'm" />
                    ); ITC: a-unique (<InlineMath math="mm'm'" />) — so the displayed group name follows the mode
                    without relabelling any frame.
                  </li>
                  <li>
                    <InlineMath math="6'/mm'm" />: <strong>the names swap exactly like the Mechanism-B pairs</strong>{' '}
                    (setting 1 is Birss's <InlineMath math="6'/mm'm" /> and ITC's <InlineMath math="6'/mmm'" />
                    ), but this group opens on setting 1 in both conventions: both tabulated standards are the same
                    physical frame.
                  </li>
                </ul>
                <p className="text-sm opacity-70 leading-relaxed">
                  Monoclinic groups keep the same short symbol in both conventions (settings are labelled First/Second,
                  i.e. c-unique/b-unique); only which setting opens by default differs — ITC mode opens on the b-unique
                  (Second) setting.
                </p>
                <p className="text-xs opacity-70 leading-relaxed italic">
              ...
              <div className="space-y-3 pt-4 border-t border-ink border-opacity-10">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  Birss's tables answer tensor-form questions in two steps: a group is first mapped to its classical
                  family class with fixed reference-axis orientations (Table 4a), and that class selects a row in the
                  rank-specific form tables (4b–4f). The Tables page shows this chain as a breadcrumb above each result,
                  so the app lookup and the manual book lookup stay recognizably the same procedure. A step-by-step
                  walkthrough with examples is in the Tables tab.
                </p>
                <p className="text-xs opacity-70 leading-relaxed italic">
              ...
              <div className="space-y-3 pt-4 border-t border-ink border-opacity-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 border border-ink border-opacity-10 space-y-2">
                    ...
                    <p className="text-xs opacity-70 leading-relaxed">
                      The operation's characteristic direction: the rotation axis for rotations and roto-inversions, the
                      mirror normal for <InlineMath math="m" />. Cardinal directions are x, y, z; in-plane directions
                      are given as the azimuth from +x in degrees (0–180°), e.g. <InlineMath math="m_{150^\circ}" /> is
                      the mirror whose normal lies in the basal plane at 150° from x.
                    </p>
                  </div>
                  <div className="p-4 border border-ink border-opacity-10 space-y-2">
                    <h4 className="font-medium">
                    ...
                    <p className="text-xs opacity-70 leading-relaxed">
                      The rotation sense about the axis (right-hand rule: + counter-clockwise, − clockwise). Shown for
                      rotations of order 3 and higher, where the two senses are distinct operations.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'physics' && (
            <section className="space-y-6">
              <div className="p-6 bg-ink/5 border border-ink border-opacity-10 space-y-4">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  The fundamental principle underlying this calculator is Neumann's Principle, which states that the
                  symmetry elements of any physical property of a crystal must include the symmetry elements of the
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  The <InlineMath math="[\det(R)]^p" /> factor is the polar/axial distinction:{' '}
                  <InlineMath math="p = 1" /> for axial (pseudo-)tensors, where it flips sign under improper operations
                  (<InlineMath math="\det(R) = -1" />
                  ); <InlineMath math="p = 0" /> for polar tensors, where it has no effect. The{' '}
                  <InlineMath math="\varepsilon" /> factor is the i-/c-type distinction:{' '}
                  <InlineMath math="\varepsilon = -1" /> for c-type tensors when <InlineMath math="R" /> is combined
                  with time reversal, and <InlineMath math="+1" /> otherwise. By applying this equation for all symmetry
                  operations in a point group, we obtain a system of linear equations that constrains the tensor
                  components, forcing some to be zero and others to be equal or related by signs.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-ink border-opacity-10">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  ...
                  frequency <InlineMath math="\omega" /> interact within a material to generate a single photon at twice
                  the frequency (<InlineMath math="2\omega" />
              ...
              <div className="p-6 bg-ink/5 border border-ink border-opacity-10 space-y-4">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  ...
                  <strong>source terms</strong> (<InlineMath math="S_i" />) that radiate the SHG signal. The effective
                  nonlinear source term (or effective polarization) is a combination of these different multipole
                  contributions:
                </p>
                <div className="space-y-3 pl-4 border-l-2 border-ink border-opacity-20 my-4">
                  ...
                  <p className="text-sm opacity-70 leading-relaxed">
                    <strong>Electric Quadrupole:</strong> Contributes via the divergence (spatial gradient) of the
                    quadrupole tensor.
                    <br />
                    <span className="inline-block mt-1">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  The calculator displays how the incoming electric field components (<InlineMath math="E_j, E_k" />)
                  couple through the non-zero tensor components to generate these induced source terms.
                </p>
                <p className="text-sm opacity-70 leading-relaxed">
                  <strong>Longitudinal vs. Transverse:</strong> For light propagating along the Z-axis in the laboratory
                  frame, the incoming electric field is purely <strong>transverse</strong> (
            ...
            <section className="space-y-6">
              <div className="space-y-3">
                ...
                <ol className="text-sm opacity-70 list-decimal list-inside space-y-2 ml-4">
                  ...
                  <li>
                    Adjust the crystal tilt (<InlineMath math="\varphi_X, \varphi_Y" />) to set the incidence angle of
                    the light, and the azimuth (<InlineMath math="\psi" />) to rotate the crystal about its surface
                    normal.
                  </li>
                  <li>
                  ...
                  <li>
                    Adjust the relative amplitude and phase of each independent tensor component using the sliders.
                  </li>
                  <li>
                    Switch between the <strong>Anisotropy</strong>, <strong>Polarizer</strong>, and{' '}
                    <strong>Analyzer</strong> tabs to observe the resulting SHG intensity polarimetry patterns in the
                    radar charts.
                  </li>
                </ol>
              </div>
              ...
              <div className="p-4 border border-ink border-opacity-10 space-y-2">
                ...
                <p className="text-xs opacity-70 leading-relaxed">
                  Each independent tensor component enters with an adjustable relative amplitude and phase. The measured
                  pattern is the squared modulus of a coherent sum, so relative phases matter: components interfere, and
                  changing a phase can reshape or rotate lobes without changing any amplitude. Values are relative
                  (arbitrary units); only ratios and phase differences affect the pattern shape.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  In a typical SHG polarimetry experiment, linearly polarized light is incident on the crystal. The
                  polarization of the incident light (polarizer) and the detected SHG light (analyzer) are rotated to
                  probe the symmetry of the nonlinear susceptibility tensor. The simulator provides three distinct
                  views:
                </p>
                <ul className="text-sm opacity-70 list-disc list-inside space-y-2 ml-4">
                  <li>
                    ...
                    <ul className="list-[circle] list-inside ml-6 mt-1 space-y-1">
                      <li>
                        <strong>Parallel Configuration:</strong> The polarizer and analyzer are aligned and rotate
                        together.
                      </li>
                      <li>
                        <strong>Crossed Configuration:</strong> The polarizer and analyzer are orthogonal (the analyzer
                        is at <InlineMath math="+90^\circ" /> relative to the polarizer).
                      </li>
                    </ul>
                  </li>
                  <li>
              ...
              <div className="space-y-3 pt-4 border-t border-ink border-opacity-10">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  ...
                  The cut presets choose which crystal direction faces the beam: the selected direction is aligned with
                  the lab Z axis (<InlineMath math="k" />
                  ), the polarization plane is X/Y. Each preset aligns a Cartesian axis (x, y or z) or a symmetry
                  diagonal; the button shows every valid designation (<InlineMath math="[hkl]" />, Cartesian axis,
                  crystallographic axis). Additional tilts (<InlineMath math="\varphi_X, \varphi_Y" />) and the azimuth
                  (<InlineMath math="\psi" />) are applied on top of the preset.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-ink border-opacity-10">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  The crystal orientation in the lab frame is controlled by a preset plus three continuous rotation
                  angles:
                </p>
                <div className="space-y-3 pl-4 border-l-2 border-ink border-opacity-20 my-4">
                  <p className="text-sm opacity-70 leading-relaxed">
                  ...
                  <p className="text-sm opacity-70 leading-relaxed">
                    ...
                    Tilt the crystal surface away from normal incidence, rotating about the lab X and Y axes. Range:
                    ±90°.
                  </p>
                  <p className="text-sm opacity-70 leading-relaxed">
                    <strong>
                    ...
                    Rotate the crystal about its surface normal (crystal-tied azimuth). At zero tilt this coincides with
                    the beam axis (lab Z). This is the in-plane rotation that sweeps the crystallographic directions
                    through the polarizer plane. Range: ±180°.
                  </p>
                </div>
                <p className="text-sm opacity-70 leading-relaxed">
                  The full rotation matrix is{' '}
                  <InlineMath math="R = R_y(\varphi_Y) \cdot R_x(\varphi_X) \cdot R_z(\psi) \cdot R_{\text{preset}}" />,
                  applied right-to-left: the preset alignment first, then the crystal-tied azimuth{' '}
                  <InlineMath math="\psi" />, then the lab-fixed tilts <InlineMath math="\varphi_X" /> and{' '}
                  <InlineMath math="\varphi_Y" />. At <InlineMath math="\varphi_X = \varphi_Y = \psi = 0" />, the result
                  is purely the preset alignment.
                </p>
              </div>
              ...
              <div className="p-6 bg-ink/5 border border-ink border-opacity-10 space-y-4">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  ...
                  ). The incident field induces the transverse source terms <InlineMath math="S_X" />,{' '}
                  <InlineMath math="S_Y" /> (see Physics → Source Terms & Transverse Fields); the detected signal is
                  proportional to the source-term component along the analyzer. The Simulator's Mathematical Model box
                  shows these formulas evaluated live for the selected group and orientation.
                </p>
                <div className="text-center overflow-x-auto py-2">
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <div className="pt-4 border-t border-ink border-opacity-10">
                    ...
                    <p className="text-sm opacity-70 leading-relaxed mt-1">
                      The expanded intensity formulas displayed in the simulator are mathematically simplified using
                      power reduction and multiple-angle trigonometric identities (e.g.,{' '}
                      <InlineMath math="\sin^2\theta = \frac{1}{2}(1 - \cos 2\theta)" /> and{' '}
                      <InlineMath math="\cos^3\theta = \frac{1}{4}(3\cos\theta + \cos 3\theta)" />
                      ).
                    </p>
                    <p className="text-sm opacity-70 leading-relaxed mt-2">
                      This converts the trigonometric polynomials into a harmonic Fourier series representation, making
                      the rotational symmetries of the crystal lattice (like 2-fold, 3-fold, or 4-fold symmetry)
                      immediately obvious. The harmonic form is preferred by default; the power form is used only when
                      it is strictly shorter (fewer terms) for that particular component, and unnecessary minus signs
                      are factored out of the absolute value expressions.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'deeper' && (
            <section className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  Every magnetic point group <InlineMath math="G" /> can be written as{' '}
                  <InlineMath math="G = H + 1'(G - H)" />, where <InlineMath math="H" /> is the halving subgroup of
                  elements that do not include time reversal, and <InlineMath math="1'" /> is the time-reversal
                  operation.
                </p>
                <p className="text-sm opacity-70 leading-relaxed">
                  <strong>i-type (time-even):</strong> The tensor is invariant under <em>all</em> operations of{' '}
                  <InlineMath math="G" />, including the time-reversed ones. Physically, i-type tensors describe
                  properties that do not depend on the magnetic order — they survive even when the material is
                  demagnetized. Example: the crystal structure contribution to SHG.
                </p>
                <p className="text-sm opacity-70 leading-relaxed">
                  <strong>c-type (time-odd):</strong> The tensor is invariant under <InlineMath math="H" /> but changes
                  sign under the time-reversed operations. Physically, c-type tensors describe properties that reverse
                  with the magnetic order. Example: the magnetization-induced SHG contribution that flips sign when the
                  sample is demagnetized or the magnetic domains are reversed. For gray groups (
              ...
              <div className="space-y-4 pt-4 border-t border-ink border-opacity-10">
                <h3 className="text-sm font-bold uppercase tracking-widest">
                  Why settings exist: the three mechanisms
                </h3>
                <div className="space-y-3 pl-4 border-l-2 border-ink border-opacity-20 my-4">
                  <p className="text-sm opacity-70 leading-relaxed">
                    <strong>Mechanism A (classical setting ambiguity):</strong> inherited from the spatial group — the
                    two in-plane symmetry-direction sets carry <em>different</em> element types (e.g. 2-folds vs.
                    mirrors in tetragonal <InlineMath math="\bar{4}2m" /> vs. <InlineMath math="\bar{4}m2" />
                    ).
                  </p>
                  <p className="text-sm opacity-70 leading-relaxed">
                    <strong>Mechanism B (time-reversal-broken equivalence):</strong> the two in-plane direction sets
                    carry the <em>same</em> element type, so the non-magnetic parent has only one setting; priming one
                    set but not the other (e.g. <InlineMath math="6'mm'" /> vs. <InlineMath math="6'm'm" />) breaks that
                    equivalence.
                  </p>
                  <p className="text-sm opacity-70 leading-relaxed">
                    <strong>Axis orientation (orthorhombic):</strong> three settings (c-unique, a-unique, and b-unique)
                    choosing which crystal axis carries the group's distinguished direction — the axis that differs from
                    the other two. The distinction is either classical (the unique polar / 2-fold axis, e.g.{' '}
                    <InlineMath math="mm2" />) or time-reversal-driven (the operation whose primed / un-primed status is
                    unique, e.g. the un-primed 2-fold in <InlineMath math="2'2'2" />, or the primed mirror in{' '}
                    <InlineMath math="mmm'" />
                    ). Groups whose three axes are equivalent — <InlineMath math="222" />, <InlineMath math="mmm" />,{' '}
                    <InlineMath math="m'm'm'" />, and the gray forms <InlineMath math="2221'" />,{' '}
                    <InlineMath math="mmm1'" /> — have a single setting only.
                  </p>
                  <p className="text-sm opacity-70 leading-relaxed">
                    <strong>Axis convention (monoclinic, 2 settings):</strong> not a different orientation but a
                    different naming convention for the same physical axis choice — <em>First</em> (
                    <InlineMath math="c" />
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  Mechanisms A and B never co-occur in the same group (one requires the two direction sets to differ in
                  element type, the other requires them to match), and the orthorhombic/monoclinic axis mechanisms are
                  unrelated to time reversal entirely — so the maximum is 3 settings, never 4.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-ink border-opacity-10">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  ...
                  <InlineMath math="c_{ijkl}" /> is unchanged when you swap <InlineMath math="i" /> and{' '}
                  <InlineMath math="j" />, when you swap <InlineMath math="k" /> and <InlineMath math="l" /> (stress and
                  strain are themselves symmetric), and when you exchange the pair <InlineMath math="ij" /> with the
                  pair <InlineMath math="kl" /> (an energy argument: the elastic energy is a quadratic form). Together
                  these cut the 81 components of a general rank-4 tensor down to at most 21 independent ones — before
                  any crystal symmetry is applied. Some rank-4 tensors carry only the pair symmetries without the pair
                  exchange (the photoelastic tensor is the standard example); their Voigt matrix is a general, not a
                  symmetric, 6x6 array.
                </p>
                <p className="text-sm opacity-70 leading-relaxed">
                  <strong>Voigt notation</strong> is the bookkeeping that exploits this: a symmetric index pair takes
                  only six values, so it is compressed to a single index 1…6 in the fixed order{' '}
                  <InlineMath math="xx \to 1,\ yy \to 2,\ zz \to 3,\ yz \to 4,\ zx \to 5,\ xy \to 6" />. The elastic
                  tensor <InlineMath math="c_{ijkl}" /> then becomes a symmetric <InlineMath math="6\times6" /> matrix{' '}
                  <InlineMath math="c_{mn}" />, and a rank-3 tensor with a symmetric jk pair (piezoelectricity{' '}
                  <InlineMath math="d_{ijk}" />) becomes the <InlineMath math="3\times6" /> scheme{' '}
                  <InlineMath math="d_{im}" />. This is exactly the Nye scheme the Tables page displays: its rows are
                  the free index <InlineMath math="i = x, y, z" /> and its columns are the compressed pairs in the order
                  above.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-ink border-opacity-10">
                ...
                <p className="text-sm opacity-70 leading-relaxed">
                  ...
                  <InlineMath math="(-6'2m')" /> -- to flag that the printed tensor form is expressed in axes rotated
                  away from the row's standard orientation (30° for trigonal/hexagonal pairs, 45° for tetragonal). The
                  bracket is a frame assertion, not decoration: the app's fixed-frame tensor output already accounts for
                  it by direct projection, so no bracket-tracking step is needed at runtime. See{' '}
                  <code className="text-xs">docs/references/BIRSS-ITC-CONVENTION-DIVERGENCES.md</code> for the full
                  derivation.
                </p>
                <p className="text-sm opacity-70 leading-relaxed">
                  Two rows of Birss's own printed Table 7 omit brackets that its own generator column (Table 6)
                  requires: <InlineMath math="(\bar{6}'2m')" /> (i-cells) and <InlineMath math="\bar{6}m'2'" /> (A- and
                  c-cells). These are documented book printing errors -- the app's values for both groups are correct
                  and independently verified against the book's own generators and against ITC Table 1.5.7.1.
                </p>
              </div>

              <div className="space-y-4 pt-4 border-t border-ink border-opacity-10">
                <h3 className="text-sm font-bold uppercase tracking-widest">
                  Table 7: reading the letter columns directly
                </h3>
                <p className="text-sm opacity-70 leading-relaxed">
                  The printed Table 7 also lists the resulting class letters directly, in its last eight columns — with
                  the book in hand, you can read your letter straight off. Those columns are <strong>built</strong> from
                  A and B by the cross-formula, and the app's chain display walks that construction rather than the
                  shortcut, for two reasons: the rotation step (step 5 of the recipe in the Tables tab) needs the source
                  symbol anyway, and only the construction makes visible why a polar tensor can end up being read from
                  an axial column.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-ink border-opacity-10">
                      ...
                      <a href={reference.href} target="_blank" rel="noopener noreferrer" className="block space-y-1">
                        <span className="font-medium underline">
                          ...
                          {reference.openAccess && (
                            <span className="ml-2 text-xs uppercase tracking-widest text-ink/70 no-underline">
                              Open Access
                            </span>
                          )}
                        </span>
                ...
                <p className="text-sm opacity-70">
                  <span className="font-medium">Sources & reference.</span> The same Birss tables and convention notes
                  the app is built on are available in full in the project repository under{' '}
                  <a
